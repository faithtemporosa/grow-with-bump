  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden tech-grid">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-40 right-20 w-32 h-32 border-2 border-accent/30 rounded-full animate-float" style={{ animationDelay: "1s" }} />
        <div className="absolute top-1/3 right-10 w-16 h-16 border-2 border-primary/30 rotate-12 animate-float" style={{ animationDelay: "2s" }} />
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-muted-foreground max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <Button
              ...
              className="glass border-primary/30 hover:bg-primary/10 text-lg px-8"
            >
              Explore Platform
            </Button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <div className="glass p-4 rounded-lg tech-border">
              <div className="text-3xl font-bold gradient-primary bg-clip-text text-transparent">1000+</div>
            ...
            <div className="glass p-4 rounded-lg tech-border">
              <div className="text-3xl font-bold gradient-accent bg-clip-text text-transparent">10M+</div>
